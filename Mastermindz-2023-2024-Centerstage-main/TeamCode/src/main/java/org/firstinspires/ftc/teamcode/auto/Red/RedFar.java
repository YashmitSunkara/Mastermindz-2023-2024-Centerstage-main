...
public class RedFar extends LinearOpMode {
    ...
    Pose2d startPose = new Pose2d(35, 60, Math.PI - Math.PI / 2);
    ...
    public void runOpMode() {
        ...
        position = blueSpikemarkPipeline.getPosition();
            ...
            if (position == BlueSpikemarkPipeline.SpikemarkPosition.THREE) {
            drive.followTrajectorySequenceAsync(drive.trajectorySequenceBuilder(startPose)
                    // for 1
                    .lineToSplineHeading(new Pose2d(startPose.getX(), startPose.getY() - (TILE_SIZE), Math.toRadians(180 - 135)))
                    .lineToSplineHeading(new Pose2d(startPose.getX() - 0.2 * TILE_SIZE, startPose.getY() - 1 * (TILE_SIZE), Math.toRadians(180 - 135)))
                    .lineToSplineHeading(new Pose2d(startPose.getX(), startPose.getY() - 1 * (TILE_SIZE), Math.toRadians(180 - 135)))
                    .splineToConstantHeading(new Vector2d(startPose.getX() + 0 * TILE_SIZE, startPose.getY() - 2.1 * (TILE_SIZE)), Math.toRadians(180 - 270))
                    .lineToSplineHeading(new Pose2d(startPose.getX() + 0.1 * TILE_SIZE, startPose.getY() - 2.1 * (TILE_SIZE), Math.toRadians(180 - 180)))
                    .lineToSplineHeading(new Pose2d(startPose.getX() + 0.95 * TILE_SIZE, startPose.getY() - 2.1 * (TILE_SIZE), Math.toRadians(180 - 180)))
                    .waitSeconds(3)
                    .waitSeconds(2)
                    .turn(Math.toRadians(5))
                    .waitSeconds(2)
                    .lineToSplineHeading(new Pose2d(startPose.getX() - 2.7 * TILE_SIZE, startPose.getY() - 2.3 * TILE_SIZE, Math.toRadians(180 - 180)))
                    .splineToConstantHeading(new Vector2d(startPose.getX() - 3.3 * TILE_SIZE, startPose.getY() - .8 * TILE_SIZE), Math.toRadians(180 - 0))
                    ...
                    .waitSeconds(4)
                    .lineToConstantHeading(new Vector2d(startPose.getX() - 3.3 * TILE_SIZE - 5, startPose.getY() - .8 * TILE_SIZE))
                    .waitSeconds(3)
                    .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                        Claw.open_left_claw();
            ...
            drive.followTrajectorySequenceAsync(drive.trajectorySequenceBuilder(startPose)
                    .lineToSplineHeading(new Pose2d(startPose.getX(), startPose.getY() - 1.1 * (TILE_SIZE), Math.toRadians(180 - 90)))
                    .splineToConstantHeading(new Vector2d(startPose.getX(), startPose.getY() - 20), Math.toRadians(180 - 90))
                    .lineToSplineHeading(new Pose2d(startPose.getX() + 0.5 * TILE_SIZE, startPose.getY() - 20, Math.toRadians(180 - 180)))
                    .lineToSplineHeading(new Pose2d(startPose.getX() + 0.5 * TILE_SIZE, startPose.getY() - 1.9 * (TILE_SIZE), Math.toRadians(180 - 180)))
                    .lineToSplineHeading(new Pose2d(startPose.getX() + 0.95 * TILE_SIZE, startPose.getY() - 1.9 * (TILE_SIZE), Math.toRadians(180 - 180)))
                    .waitSeconds(3)
                    .waitSeconds(2)
                    .turn(Math.toRadians(5))
                    .waitSeconds(2)
                    .lineToSplineHeading(new Pose2d(startPose.getX() - 2.7 * TILE_SIZE, startPose.getY() - 2.3 * TILE_SIZE, Math.toRadians(180 - 180)))
                    .splineToConstantHeading(new Vector2d(startPose.getX() - 3.3 * TILE_SIZE, startPose.getY() - 1.2 * TILE_SIZE), Math.toRadians(180 - 0))
                    .turn(Math.toRadians(5))
                    .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                        in_out_take.setInstructions(IntakeOuttake.Instructions.DEPOSIT);
                        in_out_take.setSpecificInstruction(IntakeOuttake.SpecificInstructions.RETRACT_VERTICAL);
                    ...
                    .waitSeconds(4)
                    .lineToConstantHeading(new Vector2d(startPose.getX() - 3.3 * TILE_SIZE - 5, startPose.getY() - 1.2 * TILE_SIZE))
                    .waitSeconds(3)
                    .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                        Claw.open_left_claw();
                        Claw.open_right_claw();
            ...
            drive.followTrajectorySequenceAsync(drive.trajectorySequenceBuilder(startPose)
                    .lineToSplineHeading(new Pose2d(startPose.getX(), startPose.getY() - (TILE_SIZE), Math.toRadians(180 - 45)))
                    .lineToSplineHeading(new Pose2d(startPose.getX() + 0.2 * TILE_SIZE, startPose.getY() - 1 * (TILE_SIZE), Math.toRadians(180 - 45)))
                    .lineToSplineHeading(new Pose2d(startPose.getX(), startPose.getY() - 1 * (TILE_SIZE), Math.toRadians(180 - 45)))
                    .splineToConstantHeading(new Vector2d(startPose.getX() + 0 * TILE_SIZE, startPose.getY() - 2.3 * (TILE_SIZE)), Math.toRadians(90))
                    .lineToSplineHeading(new Pose2d(startPose.getX() + 0.85 * TILE_SIZE, startPose.getY() - 2.3 * (TILE_SIZE), Math.toRadians(180 - 180)))
                    .waitSeconds(3)
                    .waitSeconds(2)
                    .turn(Math.toRadians(5))
                    .waitSeconds(2)
                    .lineToSplineHeading(new Pose2d(startPose.getX() - 2.7 * TILE_SIZE, startPose.getY() - 2.3 * TILE_SIZE, Math.toRadians(180 - 180)))
                    .splineToConstantHeading(new Vector2d(startPose.getX() - 3.3 * TILE_SIZE, startPose.getY() - 1.35 * TILE_SIZE), Math.toRadians(180 - 0))
                    .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                        in_out_take.setInstructions(IntakeOuttake.Instructions.DEPOSIT);
                        in_out_take.setSpecificInstruction(IntakeOuttake.SpecificInstructions.RETRACT_VERTICAL);
                    })
                    ...
                    .lineToConstantHeading(new Vector2d(startPose.getX() - 3.3 * TILE_SIZE - 5, startPose.getY() - 1.35 * TILE_SIZE))
                    .waitSeconds(3)
                    .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                        Claw.open_left_claw();
                        Claw.open_right_claw();
